<?php
/**
 * LifeSites2021 Theme Customizer
 *
 ...
 */
function lifesites2021_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'lifesites2021_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => 'lifesites2021_customize_partial_blogdescription',
			)
		);
	}
}
 ...
 * @return void
 */
function lifesites2021_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function lifesites2021_customize_partial_blogdescription() {
